...
const Home = () => {
    ...
    return (
        <>
            <div className="min-h-screen w-full flex flex-col items-center justify-center font-panchang-extrabold  bg-gradient-to-br from-yellow-400 via-red-300 to-blue-900">
